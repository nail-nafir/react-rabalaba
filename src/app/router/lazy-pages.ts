...
export const CalculatorPage = lazy(() => import("@/pages/calculator"));
export const CalendarPage = lazy(() => import("@/pages/calendar"));
export const LearnPage = lazy(() => import("@/pages/learn"));
...
export const AdminPaymentsPage = lazy(
  () => import("@/pages/management/payments"),
);
...
export const AdminSystemPage = lazy(
  () => import("@/pages/management/statistics"),
);
