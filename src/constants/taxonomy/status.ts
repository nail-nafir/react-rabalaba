...
/** Outcome status: `open` while live, the rest terminal. */
...
/** UI PnL filter — `tp` aggregates tp1-3, so it is its own grouping
 *  rather than a slice of FOLLOW_STATUSES. */
export const PNL_FILTERS = ["all", "tp", "sl", "manual"] as const;
